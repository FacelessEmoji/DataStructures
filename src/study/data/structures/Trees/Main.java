...
//        System.out.println("Contains Bob: " + bst.contains(minion1)); // Должно вернуть true
//        System.out.println("Contains Phil: " + bst.contains(new Minion("Phil", 32, 1))); // Должно вернуть false
//
//        // Поиск элемента
//        AbstractBinarySearchTree<Minion> searchResult = bst.search(minion2);
//        System.out.println("Search Kevin: " + searchResult.getValue().name); // Должно вернуть "Kevin"
//
